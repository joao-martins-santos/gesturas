...
class RegistrationController extends Controller
{
    ...
    public function index(){
        $dados      = Registration::all('*');
        $trans      = Transport::all('*');
        $dados_json = array();

        foreach($dados as $dado) {
            $dados_json[] = array( $dado->id, $dado->client_uri, $dado->server_uri, $dado->transport,
        ...
        return view('user.registration.index', compact('dados_json', 'trans'));
    }

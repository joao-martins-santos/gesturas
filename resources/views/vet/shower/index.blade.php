...
<section class="invoice">
    <div class="row">
        <div class="col-xs-12">
            <h2 class="page-header"><i class="fa fa-hospital-o"></i> Meus Banhos & Tosas</h2>
        </div>
    </div>

    <div class="row">
        <div class="col-xs-12">
            <a href="/vet/service/shower/new" class="btn btn-primary pull-right">Adicionar Banho & Tosa</a>
        </div>
    </div>

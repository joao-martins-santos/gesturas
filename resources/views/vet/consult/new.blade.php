...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li><a href="/vet/service/consult">Consultas</a></li>
...
<section class="invoice">
    <div class="row">
        <div class="col-xs-12">
            ...
            <i class="fa fa-hospital-o"></i> Consulta
    ...
    <form id="userForm" name="userForm">
        <div class="box-body">
          <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="page-header"><i class="fa fa-medkit"></i> Prescrição Médica</h3>
                    <button type="button" class="btn btn-primary pull-right"  data-toggle="modal" data-target="#modal-default">
                        <i class="fa fa-download"></i> Adicionar Medicamento
                    </button>
                </div>
            </div>
            <br>
            <div class="row">
             ...
             <div class="col-xs-12">
                <button type="button" id="btnFinalizar" class="btn btn-success pull-right">Finalizar Consulta</button>
            </div>
        </div>
    </form>
